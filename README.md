...
| [Sandbox](https://github.com/Paulus1337/OpenPhoenix/wiki/Sandbox) | run shell commands inside a container |
| [Nodes-and-Devices](https://github.com/Paulus1337/OpenPhoenix/wiki/Nodes-and-Devices) | pairing, scoped tokens, capabilities |
| [Policy](https://github.com/Paulus1337/OpenPhoenix/wiki/Policy) | written rules, checked, with an attestation |
| [Fleet](https://github.com/Paulus1337/OpenPhoenix/wiki/Fleet) | one isolated cell per tenant |
